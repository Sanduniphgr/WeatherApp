...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView tvLatLon, tvLocation, tvTime, tvWeather;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Set the OnBackPressedDispatcher callback
            ...
            fusedLocationClient.getLastLocation()
                    .addOnCompleteListener(task -> {
                        if (task.isSuccessful() && task.getResult() != null) {
                            ...
                            tvLatLon.setText(String.format("Lat: %s, Lon: %s", latitude, longitude));

                            Log.d(TAG, "Location: " + latitude + ", " + longitude);

                            tvLocation.setText(String.format("Lat: %s, Lon: %s", latitude, longitude));
    ...
    private void fetchWeatherData(double latitude, double longitude) {
        ...
        weatherService.getWeather(latitude, longitude, API_KEY).enqueue(new Callback<WeatherResponsee>() {
            @Override
            public void onResponse(@NonNull Call<WeatherResponsee> call, @NonNull Response<WeatherResponsee> response) {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    String weatherInfo = String.format("Temp: %.2f°C\nHumidity: %d%%\nDescription: %s",
                            temp,
